...
> {
    ...
    if let Some(replay) = storage_init_info.replay.as_ref() {
        let percent = (index_in_batch as f64 / replay.nblocks as f64) * 100.0;

        info!(log, "Block was applied";
